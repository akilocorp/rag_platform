  ...
  return (
    <div className="p-5 bg-gray-50 border border-gray-100 rounded-xl">
      <div className="flex items-center justify-between gap-4">
        <div>
          <label className="block text-[13px] font-bold text-gray-800 mb-0.5">Human-like text response delay</label>
          <p className="text-xs text-gray-500 font-medium">Add a pause after the text reply is generated. Search and tool progress remain visible.</p>
        </div>
