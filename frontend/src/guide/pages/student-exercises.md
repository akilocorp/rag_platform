...
A normal conversation, except the assistant has read your course materials.
...
- **Interactive elements** — a multiple-choice question, a chart, flashcards, a timeline.
  These appear when your professor has turned on the facilitator. Answer them in place;
...
5. Each reveal shows a chart, a comparison table, and an explanation of what actually
   happened.
6. Write a **synthesis** at the end tying it together.

Your scorecard splits **Prediction** (how many calls you got right) from **Synthesis**
(how well you explained it). Committing to a wrong prediction and then understanding why
scores better than hedging.

If you get stuck, a coach offers a hint after a while.
...
|---|---|---|
| Demonstrated understanding | 45% | Reaching the target insight, efficiently |
| Engagement | 35% | Really explaining the *why*, not coasting |
| Self-correction | 20% | Revising after a nudge, working through a contradiction |

Self-correction shows as *"not applicable"* if you were never wrong.
