...
- A **Private / Shared** toggle above them. It filters by access permission, and Private is
  selected by default. So if an assistant seems to have vanished, check whether you're
...
Understand it before you build anything.
