...
- **Change password** — set a new password. You'll need your current one.
- **Logout** — sign out. Use this on a shared or library computer.

![The account dropdown](/guide-media/account-dropdown.png)

Full details in [Passwords](/userguide/account-password).
