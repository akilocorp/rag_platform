...
// @updated   2026-07-23
// @changed   Merge: VideoScoringEditor rubric-doc import (onMeta prefills empty bot_name / introduction)
//            + remote Manager Exercise doc-upload changes (Word/PDF only, per-card drag-and-drop).
