            ...
            <>
                ...
                <footer className="p-4 sm:p-6 lg:px-12 xl:px-20 bg-white border-t border-gray-200">
                    <div className="w-full">
                        ...
                        {/* v2-style composer card: input on top, action row below */}
                        <div className="w-full rounded-[28px] bg-white border border-gray-200 shadow-[0_10px_40px_rgba(31,31,31,0.08)] p-3 sm:p-4">
                            ...
                            <div className="flex items-center justify-between gap-2 px-1">
                                <div className="flex items-center gap-1">
                                    ...
                                    {(config?.is_playground || config?.is_personal) && (
                                        <select
                                            value={sessionModel || config?.model_name || CHAT_MODEL_OPTIONS[0].id}
                                ...
                                >
                                    {isSending ? (
                                        <FaPaperPlane className="animate-send-launch text-lg" onAnimationEnd={() => setIsSending(false)} />
                                    ) : isLoading ? (
